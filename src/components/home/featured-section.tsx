...
export default function FeaturedSection() {
  ...
  return (
    <section className="px-0 lg:px-10 flex flex-col gap-y-4">
      <h1 className="px-4 lg:px-10 text-3xl font-bold">Featured</h1>
      <Carousel className="w-full">
        <CarouselContent className="-ml-1">
          {featuredProducts.map((product, index) => (
            <CarouselItem key={index} className="pl-1 basis-3/5 xs:basis-1/2 sm:basis-1/3 md:basis-1/4 lg:basis-1/6">
              <div className="p-1">
