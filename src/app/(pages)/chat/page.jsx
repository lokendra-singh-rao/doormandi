...
export default function Home() {
  ...
  const [archievedChatrooms, setArchievedChatrooms] = useState(null);
    ...
    <main className="h-[86.5vh] 2xl:px-32">
      <ResizablePanelGroup direction="horizontal" className="rounded-lg border-none">
        <ResizablePanel defaultSize={showProfileInfo ? 30 : 25} maxSize={showProfileInfo ? 30 : 30} minSize={showProfileInfo ? 30 : 20} className={`${selectedChatroom ? "hidden lg:block" : "block"}`}>
          <ChatList starredChatrooms={starredChatrooms} setStarredChatrooms={setStarredChatrooms} archievedChatroom={archievedChatrooms} setArchievedChatrooms={setArchievedChatrooms} profiles={profiles} setMessagesLoading={setMessagesLoading} setMessages={setMessages} setProfiles={setProfiles} filteredChatrooms={filteredChatrooms} setFilteredChatrooms={setFilteredChatrooms} chatrooms={chatrooms} setChatrooms={setChatrooms} selectedChatroom={selectedChatroom} setSelectedChatroom={setSelectedChatroom} setShowProfileInfo={setShowProfileInfo} />
        </ResizablePanel>
